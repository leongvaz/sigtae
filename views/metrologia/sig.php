<div class="page-header">
    <h1>SIG</h1>
    <p class="page-sub">Sistema Integral de Gestión</p>
</div>

<div class="d-flex flex-wrap gap-2 mb-3">
    <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalNorma17025">
        @ Norma 17025
    </button>
</div>
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                <iframe
                    src="<?= htmlspecialchars(($basePath ?? '') . '/metrologia/sig/data/NMX-EC-17025-IMNC-2018.pdf') ?>"
